def check(operandslist,length,out):
    ...
    if length>1:
        ...
        operandslistconcat=operandslist.copy()
        operandslistconcat[1]=concat
        
        return check(operandslistsum[1:],length,out) + check(operandslistsprod[1:],length,out)+check(operandslistconcat[1:],length,out)
